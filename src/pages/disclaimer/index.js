      ...
      <div className={styles.disclaimerContainer}>
        ...
        <div className={styles.container}>
          ...
          <p>
            ...
            1.1.1
            如果您选择建立新账号，您需要输入您的手机号码和名称，用于根据您的要求为您建立本服务账号。<br />
            1.1.2
            如果您选择使用微信(微信ID)注册，您需要提供您的微信账号名、头像、手机号码、地区（位置），用于根据您的要求为您建立本服务账号。<br />
            1.2
            当您使用边无际相关服务时，我们会收集您的IP地址，我们使用此数据是为了让您连接我们的服务器，部分功能将无法实现，无法给您提供更好的服务体验。为了帮助您了解和诊断您与本服务的连接状态，我们会收集您的无线网络、互联网连接状态，以及您是否获得连接本服务及其网络的授权。<br />
            1.3
            为保障您正常使用我们的服务、维护我们服务的正常运行、改善及优化您的服务体验，我们会收集您的Shifu运行情况、设备型号、网络类型、唯一设备标识符、软件崩溃记录、流量统计。<br />
            1.4
            为使您获得更轻松的访问体验，我们会收集您使用本软件或网站的Cookie，或本软件和您的浏览器提供的其他本地存储，这些文件记录了您的IP地址、账号、密码、浏览记录等，主要用于辨别用户身份和记录用户操作。我们收集、使用以上信息将会为您提供更好的服务。<br />
            1.5
            当您进行意见反馈时，您需要提供与意见反馈相关的详细背景、信息及您的联系方式，以便于我们尽快核实并处理您的意见。<br />
            1.6
            根据相关法律法规及国家标准，以下情形中，我们可能会收集、使用您的相关个人信息无需征求您的授权同意：<br />
            ...
            <strong>三、信息安全 3.1 安全保护措施</strong><br />
            ...
            4.2
            仅为实现外部处理的目的，我们可能会与第三方合作伙伴（第三方服务供应商、应用开发者等，例如，代表我们发出电子邮件或推送通知的通讯服务提供商）分享您的个人信息，让他们按照我们的说明、隐私政策以及其他相关的保密和安全措施来为我们处理上述信息，并用于以下用途：<br />
            1）向您提供我们的服务；<br />
            ...
            4.4
            我们可能会将所收集到的信息用于大数据分析。例如，我们可能将收集到的信息用于分析形成不包含任何个人信息的城市热力图或行业洞察报告。<br />
            4.5
            ...
            安卓、IOS、Mac、Windows版本涉及嵌入第三方代码、插件传入个人信息的情形列举如下：<br />
            ...
            当您有其他的投诉、建议、未成年人个人信息相关问题或需要删除所有访问记录时，请通过info@edgenesis.com与我们联系。（地址：北京市海淀区创业大街12号楼511室<br />
            电话：18515145818）<br />
